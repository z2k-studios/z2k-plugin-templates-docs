...
PATH_CREATE_DOC_PROMPT_TEXT="/Users/gp/Vaults/Z2K Studios Workspace/Code/Obsidian Plugins/z2k-plugin-templates-docs/scripts/import-obsidian/docs on docs/ChatGPT Reference Manual Prompt.md"
...
cp -f "$PATH_TEMPLATE_PLUGIN_SRC"  "$PATH_DESKTOP_CHAT/main.tsx.txt"
cp -f "$PATH_TEMPLATE_ENGINE_SRC"  "$PATH_DESKTOP_CHAT/main.ts.txt"
...
(If UI automation didn’t work, you may need to grant Accessibility
